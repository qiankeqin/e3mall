...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="qiankeqin"/>
	...
	<input type="hidden" name="orderShipping.receiverDistrict" value="西湖区"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="支付宝大楼"/>
</form>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>qiankeqin&nbsp;&nbsp;&nbsp;&nbsp;15800888888&nbsp;&nbsp;&nbsp;&nbsp;浙江省&nbsp;&nbsp;杭州市&nbsp;&nbsp;西湖区支付宝大楼</li>
          </ul>
        </div>
    </div>
  </div>
		...
		<div class="shipment">
			<div class="shipOrder" id="ylsorder2">
				<div class="sOrders">
					...
					<div class="sOrders">
						<div class="scon">
							<strong>菜鸟速运</strong>负责配送。<br>商品下单后尽快为您发货
						</div>
					</div>
			...
			<div class="orderTbl">
				...
				<div class="orderPInfo">
					...
					<div class="pItem pGoods">
						<a href="http://localhost:8088/item/${cart.id}.html" target="_blank">${cart.title }</a>
					</div>
